...
def main():
    ...
    if app_mode == 'Run on Image':
        ...
        demo = r"./OCR-2/valid/images/11_jpg.rf.5d7b9e03b6e040fcb3c9e1d7c2a6b590.jpg"
    ...
    # If the chosen mode is "Run on Video"
        ...
        video = st.sidebar.file_uploader(
            "Upload a Video", type=["mp4", "avi", "mov", "asf", "moov"]
        )

        # Default video for demonstration purposes
        demo = r"./Videos/demo.mp4"
